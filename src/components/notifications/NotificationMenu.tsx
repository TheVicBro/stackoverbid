            ...
            <div className="flex items-start justify-between gap-2">
              ...
              {items.length > 0 && (
                <button
                  ...
                  className="shrink-0 cursor-pointer text-[11px] font-semibold text-gray-500 hover:text-orange-600 uppercase tracking-wide"
                >
                  Clear all
                </button>
              )}
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 cursor-pointer rounded p-1 text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-colors"
